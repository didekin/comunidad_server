...
--changeset pedronevado:121 dbms:mysql
ALTER VIEW incid_importancia_user_view AS
  ...
  FROM incidencia_importancia AS im
         INNER JOIN comunidad_miembro AS cm ON im.u_id = cm.u_id AND im.c_id = cm.c_id
         INNER JOIN usuario AS u ON im.u_id = u.u_id;

--changeset pedronevado:122 dbms:mysql
...
--changeset pedronevado:123 dbms:mysql
